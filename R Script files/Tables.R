...
stargazer(avp04.step, avp04.alt1.step, avp04.cv.step, avp04.cv.alt3.step,
          ...
          dep.var.labels = c("Trial Average", "CV", "CV"),
          column.labels = c("A priori", "Best", "A priori", "Best"),
          covariate.labels = c("Suspected conc.", "LOC", "Males",
                               "Diagnosed conc.", "Amnesia",
                               "LOC x Suspected conc.", "LOC x Amnesia",
                               "Males x Diagnosed conc.",
                               "Amnesia x Diagnosed conc.",
...
stargazer(avp48.step, avp48.alt1.step, avp48.cv.step, avp48.cv.alt3.step,
          ...
          column.labels = c("A priori", "Best", "A priori", "Best"),
          covariate.labels = c("Males", "Diagnosed conc.", "Suspected conc.",
                               "LOC", "Diagnosed conc. x Suspected conc.",
                               "LOC x Suspected conc.", "Amnesia",
                               "Males x Diagnosed conc.", "Males x LOC",
                               "LOC x Diagnosed conc.",
                               "Amnesia x Diagnosed conc.",
                               "Males x LOC x Diagnosed conc.",
                               "Total conc.", "Total LOC", "Total RA",
                               "Males x Total conc.", "Males x Total LOC",
                               "Total conc. x Total LOC", "Total LOC x Total RA"),
          omit = "Constant",
...
stargazer(avp812.step, avp812.alt1.step, avp812.cv.step, avp812.cv.alt1.step,
          ...
          covariate.labels = c("Males", "Diagnosed conc.", "Suspected conc.",
                               "LOC", "Amnesia",
                               "Males x Suspected conc.",
                               "Males x LOC",
                               "Diagnosed conc. x Suspected conc.",
                               "LOC x Diagnosed conc.", "LOC x Suspected conc."),
          omit = "Constant",
